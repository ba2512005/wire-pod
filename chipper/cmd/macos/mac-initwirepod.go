...
import (
	...
	chipperserver "github.com/ba2512005/wire-pod/chipper/pkg/servers/chipper"
	jdocsserver "github.com/ba2512005/wire-pod/chipper/pkg/servers/jdocs"
	tokenserver "github.com/ba2512005/wire-pod/chipper/pkg/servers/token"
	"github.com/ba2512005/wire-pod/chipper/pkg/vars"
	wpweb "github.com/ba2512005/wire-pod/chipper/pkg/wirepod/config-ws"
	wp "github.com/ba2512005/wire-pod/chipper/pkg/wirepod/preqs"
	sdkWeb "github.com/ba2512005/wire-pod/chipper/pkg/wirepod/sdkapp"
	botsetup "github.com/ba2512005/wire-pod/chipper/pkg/wirepod/setup"
...
func StartChipper(fromInit bool) {
	...
	if vars.APIConfig.Server.EPConfig {
		...
		certPub, _ = os.ReadFile(filepath.Dir(appPath) + "/../Frameworks/chipper/epod/ep.crt")
		certPriv, _ = os.ReadFile(filepath.Dir(appPath) + "/../Frameworks/chipper/epod/ep.key")
